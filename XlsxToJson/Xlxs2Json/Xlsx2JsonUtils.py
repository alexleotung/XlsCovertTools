...
class Xlsx2JsonUtils:
    ...
    def ConstructLuaScriptGenerators(self):
        ...
        if self.__importType == EnumImportType.Single:
            ...
            file = JsonScriptGenerator(self.__importPath, self.__outPath, self.__tableType)
            ...
            for name in files:
                ...
                file = JsonScriptGenerator("{}/{}".format(self.__importPath, name), self.__outPath, self.__tableType)
                self.__files.append(file)
